# BITGET 202606 PoR Transparency Report

> Methodology: [PoR Stage Framework](../../por-transparency-framework.md)  
> Assessment JSON: [202606-assessment.json](./202606-assessment.json)
...
| Exchange | `bitget` |
| Snapshot | `202606` |
| Snapshot time | `2026-06-18T10:00:00Z` |
| PoR Stage | `Stage 0 — Trust the Exchange` |
| Gen / Evidence | `Gen 1 / E1` |
| Confidence | `low` |
| Effective PoR | `false` |

bitget snapshot 202606 remains Stage 0 in the ardmere public evaluation set.
...
| --- | --- | --- |
| `summarySnapshot` | `b90678faa847d515cf03e631f2a5c2d5a8b0e7a3d781d9f0239d7d12a4c6dbbf` | https://www.bitget.com/proof-of-reserves |

### Bundle References

| Bundle | Value |
| --- | --- |
| Artifact bundle root | `0xffffaa8be6ae7b5cb7dfb34f45fedd02a79feec80861b42624e1d591685c6184` |
| Verification bundle root | `0xaf0a4ce4b45093ff084cb6fdbadfb950fd6a6ec574f7ac1ecb37946619d20a08` |
| Artifact bundle SHA-256 | `255ec7c6e85aa53c250462a3bdab83f751351254e86a72db778a076b6b012fdd` |
| Verification bundle SHA-256 | `76d2caeb903bb1c9c1e37ac142368babfab31e5c459779595116d0247290b139` |

Local bundle paths: [202606.artifact-bundle.json](../../../artifacts/bitget/202606/bundles/202606.artifact-bundle.json), [202606.verification-bundle.v2.json](../../../artifacts/bitget/202606/bundles/202606.verification-bundle.v2.json)
...
| `user-merkle-proof` | `bitget-1` | `UNVERIFIABLE` | `0.0000` | merkel_tree_bg.json not present; download from Bitget while logged in and import via -user-proof |
...
| --- | --- | --- |
| Has public PoR been published during the last 12 months? (S0-1) | `pass` | Snapshot 202606 is in the public evaluation set. |
| Is snapshot time explicit? (S0-2) | `pass` | 2026-06-18T10:00:00Z |
