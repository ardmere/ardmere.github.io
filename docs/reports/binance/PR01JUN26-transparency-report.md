...
| Exchange | `binance` |
| Snapshot | `PR01JUN26` |
| Snapshot time | `2026-01-06T00:00:00Z` |
...
| `onchain-balance-hot` | `2.1` | `FAIL` | `0.0412` |  |
| `onchain-balance-token` | `2.0` | `FAIL` | `0.5380` |  |
| `onchain-balance-ledger` | `1.4` | `FAIL` | `0.1537` |  |
| `onchain-balance-deposit` | `1.2` | `WARN` | `0.1958` | some sampled deposit rows warn or are unverifiable |
