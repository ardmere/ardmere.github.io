...
### 1.3 Gap reporting discipline

When a dimension cannot be verified from public artifacts, ardmere marks it **`UNVERIFIABLE`** and records the reason. Missing data is **not PASS**.

- Absence of evidence is a material gap, not implicit approval.
- Login walls, sample-only packages, and unavailable proof stacks remain gaps even when a summary or marketing page looks positive.
- Merkle inclusion PASS for one account does not imply full-exchange solvency PASS.

This discipline applies to every public rating, verifier output, and evidence-chain step. See [§8.3 Traditional audit and PoR](#differences-and-complementarity-of-traditional-audit-and-por) for how PoR complements—but does not replace—financial audit.
...
Assessed exchanges in the public report set: [Exchange comparison](./reports/exchange-comparison.md).
...
Current Stage 1 assessments: [Exchange comparison](./reports/exchange-comparison.md).
...
**Counterexamples**: See [Exchange comparison](./reports/exchange-comparison.md) for Binance, OKX, and Bybit.
...
Current ardmere public assessments: [Exchange comparison](./reports/exchange-comparison.md).

Illustrative Stage placement for additional exchanges not yet in the public report set:
...
Public policy summary: [Effective PoR Standard](./effective-por-standard.md).
...
Regulators should not accept `Pre-Stage` or **Stage 0** as effective PoR. Stage thresholds and regulatory handling: [Effective PoR Standard §2](./effective-por-standard.md#stage-thresholds-for-policy-use). Stage 1 operational checklists: [§7](#7-practical-assessment-checklist).

### 8.2 Report Types That Should Not Be Conflated

See [Effective PoR Standard §3](./effective-por-standard.md#report-types-that-must-not-be-conflated).

### 8.3 Differences and Complementarity of Traditional Audit and PoR

Traditional audit and PoR answer different questions; regulatory requirements should retain both and state their respective boundaries. Comparison table and dual-track policy model: [Effective PoR Standard §1.3](./effective-por-standard.md#por-and-traditional-audit-answer-different-questions).
